...
# Вместо FLATLY выберите свою тему из https://bootswatch.com/
...
SIDEBAR_STYLE = {
    ...
    "width": "16rem",
    "padding": "2rem 1rem",
    # Цвет фона боковой панели меняем на тот, который больше всего подходит
...
sidebar = html.Div(
    [
        ...
        html.Hr(),
        html.P(
            "Учебный проект студента БСБО-14-21 Болтачева Михаила", className="lead"
        ),
        dbc.Nav(
            [
